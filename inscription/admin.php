 ...
 <table class="table">
  ...
  <tbody>
    ...
    while ($row = $list->fetch(PDO::FETCH_ASSOC)) {
      ...
      <td>'.$role .'</td>
      <td>
         <a title="modifier" href="modifier.php?id_utilisateurs='. $id .'"> <i class="bi bi-pencil-square"></i><svg width="30" height="30" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a title="archiver" onclick ="return confirm(\'voulez vous vraiment archiver \')" href="delete.php?id_utilisateurs='.$id.'"><i class="bi bi-pencil-square"></i><svg width="30" height="30" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a title="Changer role" href="Switch.php?id_utilisateurs='.$id.'"><i class="bi bi-pencil-square"></i><svg width="30" height="30" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
